...
The import path for the package is *github.com/TnGadaria/yaml-workspace*.

To install it, run:

    go get github.com/TnGadaria/yaml-workspace
...
If opened in a browser, the import path itself leads to the API documentation:
  ...
  - [https://github.com/TnGadaria/yaml-workspace](https://github.com/TnGadaria/yaml-workspace)
...
import (
        ...
        "github.com/TnGadaria/yaml-workspace"
)
