...
var unmarshalNullTests = []struct {
	...
	"s2: null\ns3: null",
	func() interface{} { m := map[string]int{"s1": 1, "s2": 2}; return m },
	func() interface{} { m := map[string]int{"s1": 1, "s2": 2, "s3": 0}; return m },
}, {
	"s2: null\ns3: null",
	func() interface{} { m := map[string]interface{}{"s1": 1, "s2": 2}; return m },
